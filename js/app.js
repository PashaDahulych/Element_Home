(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular__slider")) new core(".popular__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".buttons-slider__button.swiper-popular-prev",
                nextEl: ".buttons-slider__button.swiper-popular-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1.3,
        ...
        if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
            ...
            navigation: {
                prevEl: ".buttons-slider__button.swiper-reviews-prev",
                nextEl: ".buttons-slider__button.swiper-reviews-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1.3,
